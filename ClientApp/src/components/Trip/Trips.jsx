...
export class Trips extends Component
{
    ...
    //call the .net api to retreive the data
    /*populateTripsData(){
        axios.get("api/Trips/GetTrips").then(result => {
            const response = result.data;
            this.setState({trips: response, loading: false, failed: false, error: ""});
        }).catch(error => {
            this.setState({trips: [], loading: false, failed: true, error: "Trips cannot be loaded."});
        });
    }*/
...
export default connect(mapStateProps, {getAllTrips})(Trips);